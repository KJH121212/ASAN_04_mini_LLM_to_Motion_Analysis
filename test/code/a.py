...
def load_and_sample_video_clip(frame_paths, start_idx, end_idx, num_frames=16, target_size=(112, 112)):
...
# ==============================================================================
# 🧠 3. 표준 비디오 인코더 로드 (3D ResNet-18)
# ==============================================================================
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

print("\n🚀 일반 PyTorch 비디오 인코더(R3D_18) 모델 가동 준비 중...")
model = video_models.r3d_18(weights=video_models.R3D_18_Weights.KINETICS400_V1)
model.fc = torch.nn.Identity() # 512D 벡터 추출을 위해 분류기 컷
model.eval()
model.to(device)
# ==============================================================================
