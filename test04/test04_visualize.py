...
LOAD_PATH = PROJECT_ROOT / "test04" / "integrated_B1_r3d18_embeddings.npz"
...
print("🎨 차원 축소 연산을 시작합니다...")
embeddings_2d = {
    "UMAP": umap.UMAP(n_neighbors=15, min_dist=0.3, metric='cosine', random_state=42).fit_transform(features),
    "t-SNE": TSNE(n_components=2, perplexity=min(30, len(features)-1), metric='cosine', random_state=42).fit_transform(features),
